...
public class TextBoxManagerNivel1 : MonoBehaviour {
    ...
    public GameObject scorePanel, objectivePanel, scrollPanel, comprobar, tablaCalculo, yureSprite, yeraSprite, yureQuestion, yeraQuestion, candyBagsSprite, textBox, star1, star2, star3;
